...
public class AuthController {
	...
	public ResponseEntity<?> userSignUpHandler(@RequestBody UserSignUpRequest request) {
		...
		//after signup we need to create and pass token
	...
	public ResponseEntity<?> createDeliveryPartner(@RequestBody CreateDeliveryPartnerRequest request)
	{
	  	...
	  	deliveryPartner.setPassword(passwordEncoder.encode(request.getPassword())); //convert raw string into Hashed String
	...
	public ResponseEntity<?> deliveryPartnerSignIn(@RequestBody DeliveryPartnerSigninRequest request)
	{
	  	...
	  	if (!passwordEncoder.matches(request.getPassword(), findDeliveryPartner.getPassword())) {
			 throw new DeliveryException("Incorrect password");
		}
